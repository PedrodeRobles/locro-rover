    ...
    <div class="fixed w-full">
        <header class="flex items-center justify-between py-2 px-2 md:px-4 md:px-10 bg-red-800 text-white">
            <div class="flex items-center space-x-4 md:space-x-12">
                ...
                <Link :href="route('admin.index')" v-if="$page.props.userRoles.includes('Admin') || $page.props.userRoles.includes('Logistica')" class="flex items-center bg-indigo-600 p-4 md:p-2 rounded-lg cursor-pointer hover:bg-indigo-500 space-x-2">
