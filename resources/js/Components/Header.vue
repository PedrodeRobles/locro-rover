        ...
        <header class="flex items-center justify-between py-2 px-2 md:px-4 md:px-10 bg-red-800 text-white">
            <div class="flex items-center space-x-3 md:space-x-12">
                ...
                <Link :href="route('list')" class="flex items-center bg-gray-800 p-4 md:p-2 rounded-lg cursor-pointer hover:bg-gray-700 space-x-2">
                    ...
                    <p class="hidden md:block">Lista general</p>
                </Link>

                <Link :href="route('my-list')" class="flex items-center bg-gray-800 p-4 md:p-2 rounded-lg cursor-pointer hover:bg-gray-700 space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
                        <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V9H3V2a1 1 0 0 1 1-1h5.5v2zM3 12v-2h2v2H3zm0 1h2v2H4a1 1 0 0 1-1-1v-1zm3 2v-2h3v2H6zm4 0v-2h3v1a1 1 0 0 1-1 1h-2zm3-3h-3v-2h3v2zm-7 0v-2h3v2H6z"/>
                    </svg>
                    <p class="hidden md:block">Mi lista</p>
                </Link>

                <Link :href="route('admin.index')" v-if="$page.props.userRoles.includes('Admin', 'Logistica') || $page.props.userRoles.includes('Logistica')" class="flex items-center bg-indigo-600 p-4 md:p-2 rounded-lg cursor-pointer hover:bg-indigo-500 space-x-2">
