        ...
        <div class="bg-gray-800 text-white pt-20">
            ...
            <div class="pb-2 pl-2 flex justify-between">
              ...
              <div class="flex items-center">
                ...
                <p class="mx-2 text-lime-300 hidden md:block" v-if="$page.props.userRoles.includes('Admin', 'Logistica', 'DIOS') || $page.props.userRoles.includes('Logistica')">
            ...
            <div class="mb-2 md:hidden space-y-2">
              ...
              <p class="mx-2 text-lime-300" v-if="$page.props.userRoles.includes('Admin', 'Logistica', 'DIOS') || $page.props.userRoles.includes('Logistica')">
                Ventas: ${{ totalSalesMoney }} Recaudado: ${{ totalMoneyCollected }}
              </p>
                    ...
                    <tbody>
                        <tr v-for="(order, index) in orders" :key="order.id" :class="{'bg-lime-700': order.to_collect === 0 && (order.portions > 0 || order.batata > 0), 'bg-red-700': order.to_collect < 0, 'bg-orange-600': order.to_collect > 0 && (order.portions > 0 || order.batata > 0)}">
                            ...
                            <td class="border border-gray-600">
                              <td class="border border-gray-600" v-if="$page.props.userRoles.includes('Admin', 'Logistica', 'DIOS') || $page.props.userRoles.includes('Logistica')">
                                <!-- <input type="checkbox" class="checkbox w-9 h-9"> -->
                                <input type="checkbox" class="checkbox w-9 h-9" :data-order-id="order.id" />
                              ...
                              <td @click.prevent="destroy(order.id, order.name, order.last_name)" class="border border-gray-600 h-9 cursor-pointer" style="background-color: #dc2626;" v-if="$page.props.userRoles.includes('Admin', 'Logistica', 'DIOS') || $page.props.userRoles.includes('Logistica')">
